...
export const ANIMATION_PRESETS = Object.freeze({
  ...
  'drift-horizontal': {
    ...
    groupId: 'movement',
    parameterId: 'position.x',
    label: 'Deriva lateral suave',
    steps: [
      { atSeconds: 0, mode: 'offset', amount: 0, interpolation: 'ease' },
      { atSeconds: 0.48, mode: 'offset', amount: 54, interpolation: 'ease' },
      { atSeconds: 1.02, mode: 'offset', amount: -34, interpolation: 'ease' },
      { atSeconds: 1.55, mode: 'offset', amount: 0, interpolation: 'hold' },
    ],
  },
  'gentle-bob': {
    version: 1,
    ...
    steps: [
      { atSeconds: 0, mode: 'offset', amount: 0, interpolation: 'ease' },
      { atSeconds: 0.34, mode: 'offset', amount: -58, interpolation: 'ease' },
      { atSeconds: 0.74, mode: 'offset', amount: 18, interpolation: 'ease' },
      { atSeconds: 1.12, mode: 'offset', amount: 0, interpolation: 'hold' },
    ],
  },
  'tilt-accent': {
    version: 1,
    groupId: 'emphasis',
    parameterId: 'rotationDegrees',
    label: 'Acento inclinado',
    steps: [
      { atSeconds: 0, mode: 'offset', amount: 0, interpolation: 'ease' },
      { atSeconds: 0.16, mode: 'offset', amount: -7, interpolation: 'ease' },
      { atSeconds: 0.34, mode: 'offset', amount: 9, interpolation: 'ease' },
      { atSeconds: 0.58, mode: 'offset', amount: 0, interpolation: 'hold' },
    ],
  },
  'scale-breathe': {
    ...
    groupId: 'emphasis',
    parameterId: 'scale',
    label: 'Respiración visual',
    steps: [
      { atSeconds: 0, mode: 'factor', amount: 1, interpolation: 'ease' },
      { atSeconds: 0.38, mode: 'factor', amount: 1.07, interpolation: 'ease' },
      { atSeconds: 0.82, mode: 'factor', amount: 0.98, interpolation: 'ease' },
      { atSeconds: 1.2, mode: 'factor', amount: 1, interpolation: 'hold' },
    ],
  },
  'settle-down': {
    version: 1,
    groupId: 'entrance',
    parameterId: 'position.y',
    label: 'Caer y asentarse',
    steps: [
      { atSeconds: 0, mode: 'offset', amount: -125, interpolation: 'ease' },
      { atSeconds: 0.38, mode: 'offset', amount: 18, interpolation: 'ease' },
      { atSeconds: 0.62, mode: 'offset', amount: 0, interpolation: 'hold' },
    ],
  },
  'exit-shrink': {
    version: 1,
    groupId: 'exit',
    parameterId: 'scale',
    label: 'Cerrar reduciendo',
    steps: [
      { atSeconds: 0, mode: 'factor', amount: 1, interpolation: 'ease' },
      { atSeconds: 0.42, mode: 'factor', amount: 0.72, interpolation: 'ease' },
      { atSeconds: 0.68, mode: 'absolute', amount: 0.001, interpolation: 'hold' },
    ],
  },
  'arm-raise': {
    version: 1,
