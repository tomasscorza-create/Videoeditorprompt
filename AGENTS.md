...
- La ampliación de variabilidad creativa V0–V2 está implementada y verificada. El runtime, compilador y editor admiten escenas con cero, uno o dos personajes, un solo turno mínimo y voz fuera de campo sin personaje. Las escenas nuevas pueden comenzar vacías como borradores; Edición y timeline permiten agregar narración, cambiar entre narrador y personaje, variar el reparto por escena, dividir con un turno por lado y conservar referencias mediante undo/redo. El Director todavía genera el plan histórico rígido; flexibilizar su creación corresponde a V3 y no debe darse por implementado.
...
- Las Fases V0 y V1 de variabilidad creativa están implementadas y verificadas. V0 congela cuatro modos (`voiceover`, `solo`, `dialogue`, `visual-with-voiceover`), pesos editoriales, recetas, secuencias coordinadas y una matriz honesta por consumidor. V1 amplía aditivamente autoría, `scene-config-v2`, preparación, evaluador, verificadores y manifiesto renderizado para cero, uno o dos personajes y de uno a veinte turnos; una voz fuera de campo no referencia personaje, gesto ni layout. Piper y FFprobe siguen determinando la duración. Los pilotos `runtime-flexible-v1` demuestran MP4 deterministas para cero y un personaje, y compilación integrada 0/1/2. El Editor flexible y el Director V2 continúan pendientes.
