...
- La Fase V0 de variabilidad creativa está implementada y verificada contractualmente, todavía aislada del producto. Congela cuatro modos de escena (`voiceover`, `solo`, `dialogue`, `visual-with-voiceover`), de cero a dos personajes visibles, turnos de personaje o voz fuera de campo, pesos editoriales de duración, recetas de escena, secuencias coordinadas y una matriz compartida que distingue capacidades disponibles, limitadas, de borrador, planificadas o excluidas por consumidor. V0 no cambia el runtime v2, el editor ni el Director actual; V1 deberá hacer renderizables esos contratos antes de exponerlos a la IA.
...
- Los contratos V0 de `voiceover`, `solo` y `visual-with-voiceover` todavía no tienen consumidor de runtime ni UI. El Director actual continúa generando el plan V1 rígido de dos personajes; no debe recibir los nuevos modos, recetas o secuencias hasta que V1 demuestre preview y MP4 equivalentes.
