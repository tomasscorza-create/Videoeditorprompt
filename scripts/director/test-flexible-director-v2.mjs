    ...
    scenes: [
      {
        ...
        speech: [{ kind: 'voiceover', voiceId: 'voz-ald-mx-v1', text: 'Primero vemos el dato que cambia la pregunta.', gapAfterSeconds: 0 }],
      },
      {
        ...
        speech: [{ kind: 'character', speakerRoleId: 'guia', text: 'Una sola voz puede desarrollar la idea sin forzar un diálogo.', gestureId: 'point', gestureAtWord: 2, gapAfterSeconds: 0 }],
      },
      {
        ...
        participants: [
          ...
          { roleId: 'rol-b', characterResourceId: 'mono-verde-v1', voiceId: 'voz-davefx-es-v1', animationPresetId: 'talk-calm' },
        ], visualElements: [],
        speech: [
          { kind: 'character', speakerRoleId: 'rol-a', text: 'La variedad mejora el ritmo.', gestureId: 'celebrate', gapAfterSeconds: 0.15 },
          { kind: 'character', speakerRoleId: 'rol-b', text: 'Siempre que cada recurso tenga una función.', gestureId: 'neutral', gapAfterSeconds: 0 },
        ],
      },
    ],
  };
...
await test('secuencia-coordinada-se-expande-sin-sobrescribir-pistas', () => {
  const { project } = normalizeDirectorPlanV2(basePlan(), catalog, { recipes, projectId: 'gate-receta-v2' });
