...
assert.equal(valid.catalog.entries.length, 11);
assert.deepEqual([...valid.resources.values()].map((entry) => entry.type), ['character', 'character', 'character', 'character', 'character', 'character', 'character', 'character', 'voice', 'voice', 'background']);
