...
assert.equal(valid.catalog.entries.length, 10);
assert.deepEqual([...valid.resources.values()].map((entry) => entry.type), ['character', 'character', 'character', 'character', 'character', 'character', 'character', 'voice', 'voice', 'background']);
