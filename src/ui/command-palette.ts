...
function actions(): CommandAction[] {
  const entries: CommandAction[] = [
    ...
    },
    {
      ...
      label: 'Crear base con el Director',
      group: 'Director',
    ...
    { id: 'phase-idea', label: 'Ir a Idea', group: 'Director', run: () => clickTarget('[data-director-phase="idea"]') },
    {
      id: 'phase-base',
      label: 'Ir a Base',
      group: 'Director',
      unavailableReason: disabledReason('[data-director-phase="base"]', 'Todavía no hay una base.'),
      run: () => clickTarget('[data-director-phase="base"]'),
    },
    {
      id: 'phase-video',
      label: 'Ir a Video',
      group: 'Director',
      unavailableReason: disabledReason('[data-director-phase="video"]', 'Todavía no hay una base.'),
      run: () => clickTarget('[data-director-phase="video"]'),
    },
